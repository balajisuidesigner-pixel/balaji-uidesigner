 ...
 *
 * Below is a more detailed breakdown of the supported animation eventsbckup provided by pre-existing ng directives:
 *
 ...
 * </pre>
 *
 * JavaScript-defined animations are created with a CSS-like class selector and a collection of eventsbckup which are set to run
...
angular.module('ngAnimate', ['ng'])
  ...
  .config(['$provide', '$animateProvider', function($provide, $animateProvider) {
    ...
    $animateProvider.register('', ['$window', '$sniffer', '$timeout', '$$animateReflow',
      ...
      // If unprefixed eventsbckup are not supported but webkit-prefixed are, use the latter.
      // Otherwise, just use W3C names, browsers not supporting them at all will just ignore them.
      // Note: Chrome implements `window.onwebkitanimationend` and doesn't implement `window.onanimationend`
      // but at the same time dispatches the `animationend` event and not `webkitAnimationEnd`.
      // Register both eventsbckup in case `window.onanimationend` is not supported because of that,
      ...
      function animateRun(animationEvent, element, className, activeAnimationComplete) {
        ...
        function onAnimationProgress(event) {
           ...
           * mock animations properly. Real eventsbckup fallback to event.timeStamp,
